...
const API_BASE = 'http://localhost:5001/api/student';
...
export const studentService = {
  ...
  enrollInCourse: async (courseId) => {
    ...
    axios.post('http://localhost:5001/api/activities', {
      type: 'course',
  ...
  sendMessage: async (id, text) => {
    try {
      const res = await axios.put(`http://localhost:5001/api/messages/${id}/reply`, {
        text,
        sender: 'Student'
      });
      // Return updated list
