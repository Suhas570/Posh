    ...
    <div className="min-h-screen bg-[#f1f5f9] saas-dot-grid flex text-left font-sans antialiased text-slate-800">
      ...
      >
        ...
        <header className="h-20 bg-white/75 backdrop-blur-md border-b border-slate-200/40 flex items-center justify-between px-6 md:px-8 sticky top-0 z-30 transition-all duration-300">
          ...
          {/* Student profile preview badge & Logout */}
          <div className="flex items-center gap-4">
            <div className="flex items-center gap-2.5">
              ...
              <div className="hidden sm:flex flex-col text-left">
                <span className="text-xs font-bold text-slate-800 leading-tight">{user?.name || 'Manoj'}</span>
            ...
            <button
              onClick={logout}
              title="Logout"
              className="p-2 rounded-xl border border-slate-200/60 hover:bg-rose-50 text-slate-500 hover:text-rose-600 hover:border-rose-200 transition-all flex items-center gap-1.5 text-xs font-bold cursor-pointer"
            >
              <LogOut size={16} />
