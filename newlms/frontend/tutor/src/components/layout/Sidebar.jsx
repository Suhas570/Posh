  ...
  return (
    ...
    >
      ...
      <div className="p-3 border-t border-slate-100/50">
        <button
          onClick={logout}
          className={`w-full flex items-center gap-3 px-3.5 py-2.5 rounded-xl transition-all text-xs font-bold text-rose-600 hover:bg-rose-50 border border-rose-100/80 cursor-pointer ${isCollapsed ? 'justify-center' : ''}`}
          title="Logout"
        >
          <LogOut size={18} />
